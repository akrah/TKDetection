...
// Paramètres de la détection des zones de nœuds par carte d'accumulation
#define ZMOTIONMAP_BINARIZATION_THRESHOLD 500
#define ZMOTIONMAP_MAXIMUM_CONNECTED_COMPONENT_DISTANCE 5
#define ZMOTIONMAP_MINIMUM_CONNECTED_COMPONENT_SIZE 15
