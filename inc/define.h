...
#define HISTOGRAM_ANGULAR_SMOOTHING_RADIUS 15
#define HISTOGRAM_ANGULAR_PERCENTAGE_OF_MINIMUM_HEIGHT_OF_MAXIMUM 30
#define HISTOGRAM_ANGULAR_MINIMUM_WIDTH_OF_INTERVALS 10
#define HISTOGRAM_ANGULAR_DERIVATIVE_SEARCH_PERCENTAGE 30
