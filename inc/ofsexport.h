...
namespace OfsExport
{
	void process( const Billon &billon, const Interval<int> &interval, const QString &fileName, const int &nbEdgesPerSlice, const int &radiusOfTubes = 4, bool normalized = true );
