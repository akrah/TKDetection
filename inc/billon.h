...
public:
	...
	BillonTpl * restrictToArea( const int &nbPolygonsPoints, const int &threshold, const Marrow *marrow = 0 );
        QVector<rCoord2D> getRestrictedAreaVertex( const int &nbPolygonsPoints, const int &threshold, const Marrow *marrow = 0 ) ;
...
template< typename T >
 QVector<rCoord2D> BillonTpl<T>::getRestrictedAreaVertex( const int &nbPolygonPoints, const int &threshold, const Marrow *marrow ){
