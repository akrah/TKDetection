...
namespace IntervalsComputer
{
	...
	QVector<Interval> intervalsComputing( const QVector<qreal> &hist, const QVector<int> &maximums, int derivativePercentage, int minimumWidthOfIntervals = DEFAULT_MINIMUM_WIDTH_OF_INTERVALS, bool loop = false );
