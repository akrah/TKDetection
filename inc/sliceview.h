...
public:
	...
	void drawSlice( QImage &image, const Billon &billon, const TKD::SliceType &sliceType, const iCoord2D &center, const uint &sliceNumber, const Interval<int> &intensityInterval,
