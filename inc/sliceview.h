...
public:
	...
	void drawSlice( QImage &image, const Billon &billon, const TKD::SliceType &sliceType, const uiCoord2D &center, const uint &sliceNumber, const Interval<int> &intensityInterval,
			   const uint &zMotionMin, const uint &angularResokution, const TKD::ViewType &axe, const TKD::OpticalFlowParameters &opticalFlowParameters,
...
private :
	void drawCurrentSlice( QImage &image, const Billon &billon, const uint &sliceIndex,
				   const Interval<int> &intensityInterval, const uint &angularResolution, const TKD::ImageViewRender &aRender, const TKD::ViewType &axe = TKD::Z_VIEW );
	void drawMovementSlice( QImage &image, const Billon &billon, const uint &sliceIndex, const Interval<int> &intensityInterval,
							const uint &zMotionMin, const uint &angularResolution, const TKD::ViewType &axe = TKD::Z_VIEW );
