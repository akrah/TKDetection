...
int main(int argc, char** argv)
{
  ...
  meshQuadZCylinder(imageVol, viewer, meshTrunkSlice4, center, 0,  cylinderRadius, true, cutSection4FirstIndex, cutSection4LastIndex, 
                    0, 0, angleStep, gridSize, Z3i::RealPoint(0,0,   cutSectionSpace*2+cutSection2Space*2+cutSection3Space*2+cutSection4Space));     
  meshQuadZCylinder(imageVol, viewer, meshTrunkEnd, center, 0,  cylinderRadius, true, cutSection4LastIndex, endBillonSection,
                    0, 0, angleStep, gridSize, Z3i::RealPoint(0,0, cutSectionSpace*2+cutSection2Space*2+cutSection3Space*2+cutSection4Space*2)); 

  embeddMeshInVol(imageVol, viewer, meshTrunkSlice4, ColorizeFonctor(colorCoefs[0], colorCoefs[1], colorCoefs[2]), Z3i::RealPoint(0,0, cutSectionSpace*2+cutSection2Space*2+cutSection3Space*2+cutSection4Space));
  embeddMeshInVol(imageVol, viewer, meshTrunkEnd, ColorizeFonctor(), Z3i::RealPoint(0,0, cutSectionSpace*2+cutSection2Space*2+cutSection3Space*2+
                                                                                    cutSection4Space*2));
